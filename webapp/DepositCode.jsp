...
try
{
	...
	if(i>=1)
	{
		...
		if(rs.next())
		{
			...
			out.print("<h2 id = 'welcome_text'>Welcome "+username);
			out.print("</h2><br><h1 id = 'info'> Account Info </h1>");
			out.print("<br><p id = 'amount_text'> Your Amount is increased by <b>"+amount+"</b></p>");
			out.print("<br><p id = 'amount_text'> Total amount is <b>"+ tot_amount+".0</b></p>");
		}
