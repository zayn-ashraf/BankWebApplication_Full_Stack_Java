     ...
     <body>
         ...
         <nav class = "content-body">
             ...
             <div class = "logo-body">
               ...
               <center><p class = "register-head">TRANSFER FORM</p></center>
               <form action="TransferCode.jsp" method = "post">
                ...
                <tr>
                    ...
                    <td>
                        <input type = "text" name = "tacno" placeholder="Enter Account Number">
                    </td>
                </tr>
                <tr><td></td><td></td></tr> 
                ...
                <tr>                   
                    <td >
                        <input id = "button-center" type = "submit"   value = "Transfer">
